...
fn get_smallest_dimension(dim_1: (u32, u32), dim2: (u32, u32)) -> (u32, u32) {
...
fn combine_images(image_1: DynamicImage, image_2: DynamicImage) -> Vec<u8> {
  ...
  alternate_vectors(vec_1, vec_2)
}

fn alternate_vectors(vec_1: Vec<u8>, vec_2: Vec<u8>) -> Vec<u8> {
  let mut combined_data = vec![0u8; vec_1.len()]; // [0, 0, 0, 0, 0, n]
